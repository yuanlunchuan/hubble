...
<link
	href="${pageContext.request.contextPath}/static/custom/css/contact_us_new.css"
	rel="stylesheet">
</head>
<body>
	...
	<div class="container content">
		...
		<div class="row border padding-top-5">
			<div class="col-md-6">
				<form class="form-horizontal" action="${pageContext.request.contextPath}/contactUs/add" method="post">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">主题<span
							class="red-text">*</span></label>
						<div class="col-sm-10">
