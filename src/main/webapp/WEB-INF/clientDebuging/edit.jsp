     ...
     <div class="col-md-6 col-md-offset-3 request-form">
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
			<form action="${pageContext.request.contextPath}/clientDebuging/update" method="post" class="form-horizontal">
			  <input type="hidden" class="form-control" value="${unRegisterAPI.id }" name="id">
			  <div class="form-group">
			    <label class="col-sm-2 control-label">接口名称</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" value="${unRegisterAPI.apiName }" name="apiName">
			    </div>
			  </div>
			  <div class="form-group">
			    <label class="col-sm-2 control-label">接口url</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" value="${unRegisterAPI.api }" name="api">
			    </div>
			  </div>
			  <div class="form-group">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <textarea class="form-control" rows="3" value="${unRegisterAPI.param }" name="param">${unRegisterAPI.param }</textarea>
			    </div>
			  </div>
			  <div class="form-group">
			    <label class="col-sm-2 control-label">响应数据</label>
			    <div class="col-sm-10">
			      <textarea class="form-control" rows="3" value="${unRegisterAPI.response }" name="response">${unRegisterAPI.response }</textarea>
			    </div>
			  </div>
			  <div class="form-group">
